  ...
  function UpdateForm(data) {
    return (
      ...
      <form className="produpdateForm" onSubmit={handleUpdateProduct}>
        ...
        <input
          type="text"
          ref={updateID_klienta}
          required
          disabled
          defaultValue={selectedKlient[0]}
        />
        <br></br>
        ...
        <input
          type="text"
          ref={updateID_użytkownika}
          required
          disabled
          defaultValue={selectedKlient[1]}
        />
        <br></br>
        <label>Imie</label>
        <br></br>
